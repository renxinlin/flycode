...
/**
  ...
  * All rights reserved.
  *
  * This software is lihspi1censed under terms that can be found in the LICENSE file
...
void MX_SPI1_Init(void)
{
  ...
  hspi1.Init.BaudRatePrescaler = SPI_BAUDRATEPRESCALER_64; // SPI时钟频率为系统时钟频率的六十四分之一
